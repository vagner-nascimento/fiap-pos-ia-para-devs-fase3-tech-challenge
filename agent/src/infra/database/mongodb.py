"""
Gerenciamento de conexão com o MongoDB para o serviço de agente médico.

Segue o mesmo padrão singleton do backend principal.
"""
import os
...
def test_connection() -> bool:
    ...
    try:
        ...
        print(f"Erro ao testar conexão com MongoDB: {exc}")
        return False
